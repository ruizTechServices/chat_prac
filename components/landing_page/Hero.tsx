  ...
  return (
    <section className="relative text-center mb-20 md:mb-32 flex flex-col items-center">
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 shadow-sm backdrop-blur-lg mb-4 animate-fade-in">
        ...
        <Badge variant="outline" className="bg-white/20 border-none text-primary font-medium tracking-wide">Powered by GPT-4o, Mistral-Large, Gemini 1.5</Badge>
      </div>
      ...
      <div className="flex justify-center gap-4 animate-fade-in delay-200">
        ...
        <Button size="lg" variant="outline" className="text-lg px-8 py-5 hover:scale-105 transition-transform border-primary/40 bg-white/10 text-primary/90 hover:bg-primary/10">Explore Pro ($50/mo)</Button>
      </div>
    </section>
  );
}
